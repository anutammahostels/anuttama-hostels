      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8 pt-24 lg:pt-32 pb-12 lg:pb-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex justify-center mb-6 lg:mb-8 animate-fade-in">
            <div className="inline-flex items-center gap-2 lg:gap-3 px-3 lg:px-5 py-2 rounded-full bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-colors cursor-default group">
