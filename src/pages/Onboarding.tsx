  ...
  const canProceed = () => {
    switch (currentStep) {
      ...
      case 2:
        return true;
      case 3:
        return data.attendanceMarkedBy.length > 0;
      case 4:
        return data.paymentModes.length > 0;
      default:
        return true;
    }
  };
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="bg-card rounded-2xl border border-border/50 shadow-xl p-6 sm:p-8 mb-8 min-h-[400px]">
          ...
          >
            ...
            {currentStep === 2 && (
              <PropertyRulesStep data={data} updateData={updateData} section="rules" />
            )}
            {currentStep === 3 && (
              <PropertyRulesStep data={data} updateData={updateData} section="mess" />
            )}
            {currentStep === 4 && (
